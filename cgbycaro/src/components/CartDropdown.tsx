...
const CartDropdown = () => {
  ...
  const handleRemoveItem = async (id: number, color: string, colorId?: number) => {
  ...
  const handleUpdateQuantity = async (id: number, color: string, newQuantity: number, colorId?: number) => {
    const itemKey = `${id}-${color}`;
    setIsUpdating(prev => ({ ...prev, [itemKey]: true }));
    await new Promise(resolve => setTimeout(resolve, 150)); // Simulate async operation
    updateQuantity(id, color, newQuantity, colorId);
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="relative flex-shrink-0">
                              ...
                              {/* Remove Button */}
                              <button
                                onClick={() => handleRemoveItem(item.id, item.color, item.colorId)}
                            ...
                            <div className="flex items-center gap-1 bg-gray-700 rounded-lg p-0.5 border border-gray-600">
                              <Button
                                ...
                                onClick={() => handleUpdateQuantity(item.id, item.color, item.quantity - 1, item.colorId)}
