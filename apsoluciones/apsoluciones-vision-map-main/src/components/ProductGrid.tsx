...
const ProductGrid: React.FC<ProductGridProps> = ({ 
  ...
  useEffect(() => {
    // Solo filtrar si los productos ya se han cargado
    ...
    if (categoryFilter) {
      filtered = filtered.filter(product => 
        product.categoria === categoryFilter.id
      );
    }
    ...
    if (selectedCategoryFilter && selectedCategoryFilter !== '') {
      filtered = filtered.filter(product => 
        product.categoria === parseInt(selectedCategoryFilter)
      );
    }
  ...
  }, [products, categoryFilter, selectedCategoryFilter, searchTerm, sortBy, sortOrder, loading]);
