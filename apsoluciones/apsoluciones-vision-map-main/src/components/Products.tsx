...
import { ExternalLink, Shield, Zap, FileText, AlertTriangle, Grid3X3, ChevronRight, Package } from 'lucide-react';
import { getCategorias, getSubCategorias, Categoria, SubCategoria } from '@/data/staticData';
...
const Products: React.FC = () => {
  ...
  useEffect(() => {
    const loadCategorias = () => {
      ...
      try {
        const categoriasActivas = getCategorias();
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
                ...
                <p className="text-sm text-gray-600 mb-3">Sistema avanzado para disipación controlada de cargas electroestáticas</p>
                <div className="mb-3">
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Especificaciones Técnicas:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Resistividad: ≤ 10⁶ Ω·cm</li>
                    <li>• Tensión de operación: 0-50kV</li>
                    <li>• Tiempo de descarga: < 0.5 segundos</li>
                    <li>• Material: Aleación conductiva especial</li>
                    <li>• Temperatura operativa: -40°C a +85°C</li>
                    <li>• Certificación: IEC 61340-5-1</li>
                  </ul>
                </div>
                <div className="mb-3">
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Instalación:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Conexión a tierra ≤ 1Ω</li>
                    <li>• Montaje en superficie conductiva</li>
                    <li>• Verificación con medidor de resistencia</li>
                  </ul>
                </div>
                <div>
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Aplicaciones:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Instalaciones críticas</li>
                    <li>• Centros de datos</li>
                    <li>• Laboratorios electrónicos</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
                <div className="bg-green-50 p-3 rounded-lg mb-3">
                  <h5 className="font-semibold text-green-800">Apantallador Contrarayos (ACR)</h5>
                </div>
                <p className="text-sm text-gray-600 mb-3">Sistema de protección especializado contra descargas atmosféricas</p>
                <div className="mb-3">
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Especificaciones Técnicas:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Corriente de descarga: 200kA (8/20μs)</li>
                    <li>• Nivel de protección: Clase I</li>
                    <li>• Radio de protección: hasta 100m</li>
                    <li>• Material: Acero inoxidable 316L</li>
                    <li>• Resistencia mecánica: 150 km/h viento</li>
                    <li>• Certificación: IEC 62305-3</li>
                  </ul>
                </div>
                <div className="mb-3">
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Instalación:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Altura mínima: 2m sobre estructura</li>
                    <li>• Conductor bajante: Cu 50mm²</li>
                    <li>• Sistema de puesta a tierra dedicado</li>
                  </ul>
                </div>
                <div>
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Aplicaciones:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    ...
                    <li>• Edificaciones industriales</li>
              ...
              <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
                <div className="bg-purple-50 p-3 rounded-lg mb-3">
                  <h5 className="font-semibold text-purple-800">Aglomerante Conductivo GL</h5>
                </div>
                <p className="text-sm text-gray-600 mb-3">Compuesto aglomerante conductivo de alta performance</p>
                <div className="mb-3">
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Especificaciones Técnicas:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Resistividad: ≤ 0.1 Ω·m</li>
                    <li>• Densidad: 2.3 g/cm³</li>
                    <li>• Tiempo de fraguado: 24-48 horas</li>
                    <li>• Resistencia compresión: 25 MPa</li>
                    <li>• pH: 12-13 (alcalino)</li>
                    <li>• Certificación: IEEE 80</li>
                  </ul>
                </div>
                <div className="mb-3">
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Instalación:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    <li>• Mezcla: 1 parte agua / 4 partes GL</li>
                    <li>• Aplicación en terreno húmedo</li>
                    <li>• Compactación mecánica requerida</li>
                  </ul>
                </div>
                <div>
                  <h6 className="text-xs font-semibold text-gray-700 mb-1">Aplicaciones:</h6>
                  <ul className="text-xs text-gray-500 space-y-1">
                    ...
                    <li>• Mejoramiento de conductividad</li>
                    <li>• Protección electromagnética</li>
                  </ul>
                </div>
              </div>
            </div>
