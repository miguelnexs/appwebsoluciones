...
// TODO: Implementar funciones de API para pedidos
// import { 
//   getPedidos, 
...
const getPedidos = async () => ({ success: true, data: [] });
const getEstadisticasPedidos = async () => ({ success: true, data: { total: 0, pendientes: 0, completados: 0, cancelados: 0 } });
const deletePedido = async (id) => ({ success: true });
const cambiarEstadoPedido = async (id, estado) => ({ success: true });
const getHistorialPedido = async (id) => ({ success: true, data: [] });
